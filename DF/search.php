                      ...
                      <div class="article-container">
                        <?php 
                            if (isset($_POST['submit-search'])) {
                                ...
                                $sql = "SELECT * FROM posts NATURAL JOIN topics WHERE PostText LIKE '%$search%' OR TopicId LIKE '%$search%' OR Owner LIKE '%$search%' OR Created LIKE '%$search%' OR Title LIKE '%$search%'";
